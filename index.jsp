      ...
      <div class="container_12">
        <div class="grid_6">
          ...
          <div class="extra_wrapper style1">
            <p>Γίνε εθελοντής και προσέφερε αγάπη, φροντίδα και θαλπωρή. Το μόνο που απαιτείται είναι λίγος χρόνος απο την καθημερινότητα σου για να φροντίσεις ζωάκια που έχουν ανάγκη απο πολλές αγκαλίτσες, λιχουδιές και περιποίηση. Μην χάνεις χρόνο και γίνε εθελοντής.</p>
          </div>
        </div>
